...
<html lang="en">
  ...
  <head>
    ...
    <!-- PLUGINS CSS STYLE -->
    <link rel="stylesheet" href="{{ asset('assets/template/plugins/bootstrap/bootstrap.min.css') }} ">
    <link rel="stylesheet" href="{{ asset('assets/template/plugins/themify-icons/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/plugins/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/plugins/slick/slick-theme.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/plugins/fancybox/jquery.fancybox.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/plugins/aos/aos.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/landing-page/css/font-awesome.css') }}">

    <!-- CUSTOM CSS -->
    <link rel="stylesheet" href="{{ asset('assets/template/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/preloader.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/header.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/superiority.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/slider-slick.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/superiority.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/contact.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/slider.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/template/css/additional.css') }}">
    ...
    <section class="gradient-banner" style="background-image: linear-gradient(
        ...
        url('img/gedung.png'); background-repeat:no-repeat">
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-5">
                    ...
                    <div class="contact-text">
                        ...
                        <p class="text-white">CS 1 : <a style="text-decoration: underline !important; font-weight: bold !important" href="https://wa.me/6281909242411">hubungi kami (klik disini)</a>
                ...
                <div class="col-lg-8 col-md-6 col-sm-12">
                    <div class="contact-form">
                        <form id="contact" action="https://ppdb.smkwikrama.sch.id/submitMessage" method="POST">
                            <input type="hidden" name="_token" value="R09zFk2H84Ls21wHqT1Q1qaKk7Gbs0biw54jWUVN">                          <div class="row">
                            <div class="col-lg-12">
                                <fieldset>
