      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, b</div></a>
      ...
      <div class="main-content">
        <section class="content">
          ...
          <div class="section-body">
            <h2 class="section-title">Hi, b!</h2>
            ...
            <div class="content">
                <ul id="progressbar"> 
                    ...
                    <li class=" ">  Verif Data</li>

                    <li class="">  Berkas</li>

                    <li class="">  Prawawancara</li> 

                    <!-- <li class="">  Ketidakhadiran</li> --> 

                    <!-- <li class="">  Upload Berkas</li> -->

                    <li class="">  Wawancara </li>  

                    <li class="">  Pengumuman </li>  

                    <li class="">  Kesepahaman </li>  

                    <li class="">  Daftar Ulang </li>  
                </ul> 
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card1 mt-3 p-3 g-2">
                            <div class="d-flex align-items-center">
                                <img alt="image" src="../assets/admin/img/avatar/avatar-1.png" class="rounded-circle picture">
                            </div>
                            <div class="mt-3">
                                <h2 class="text1">b</h2>
                            </div>
                        ...
                        <div class="card card3 mt-3">
                                <div class="card-header pb-0 bg-white"> <h5 class="font-weight-bold mt-2">Langkah yang harus dikerjakan</h5></div>
                                <div class="card-body">
                                    <p style="color: #333; font-size: 0.9rem">
                                                                                <strong>Pembayaran Registrasi</strong>
                                        <br>
                                        Pendaftaran telah berhasil. Silahkan lakukan pembayaran sebelum <mark><small class="font-weight-bold">26-12-2022</small></mark>
                                        <br>
                                        <a href="https://ppdb.smkwikrama.sch.id/student/dashboard/payment" class="btn mt-3 btn-block btn-primary">Menuju Halaman Pembayaran</a>
                                                                            </p>
                            </div>
                        </div>
                    </div>
